...
//    
//    var maxValue: Double {
//        guard let max = chartData.values.max() else {
//            return 1
//        }
//        return max != 0 ? max : 1
//    }
...
//                   spacing: (geometry.size.width - Constant.spacing) / CGFloat(self.chartData.data.count * 3)) {
...
//                            .animation(Animation.easeIn(duration: 0.2), value: chartData)
//                    }
//            }
...
//        return Double(chartData.values[index]) / Double(maxValue)
//    }
//
...
////        BarChartRow(chartData: .constant(.init([0.2, 0.9, 1.0, 0.2, 0.9, 1.0])),
////                    style: .init(backgroundColor: .green, foregroundColor: [.orangeBright]))
////    }
////}
